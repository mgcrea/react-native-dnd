...
<Properties>
  ...
  <Property name="delay" type="number" optional defaultValue={`0`}>
  ...
  <Property name="tolerance" type="number" optional defaultValue={`false`}>
    A number representing the distance, in pixels, of motion that is tolerated before the drag operation is aborted.
  </Property>
