...
For most use cases, you should use the source of this component as a blueprint to create a custom draggable component using [useDraggable](./../hooks/usedraggable).
