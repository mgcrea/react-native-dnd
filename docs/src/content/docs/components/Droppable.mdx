...
For most use cases, you should use the source of this component as a blueprint to create your custom droppable component using [useDroppable](./../hooks/usedroppable).
